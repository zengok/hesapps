  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        primary: indigo,
        surface: Color(0xFFEEEEF8),
        onSurface: Color(0xFF1A1A2E), // koyu metin
        onPrimary: Colors.white,
      ),
      textTheme: const TextTheme(
        bodyLarge: TextStyle(color: Color(0xFF1A1A2E)),
        bodyMedium: TextStyle(color: Color(0xFF1A1A2E)),
        bodySmall: TextStyle(color: Color(0xFF444466)),
        headlineSmall: TextStyle(color: Color(0xFF0A0A1F)),
        titleMedium: TextStyle(color: Color(0xFF1A1A2E)),
        titleLarge: TextStyle(color: Color(0xFF0A0A1F)),
      ),
      appBarTheme: const AppBarTheme(
        backgroundColor: Colors.transparent,
        foregroundColor: Color(0xFF1A1A2E), // koyu başlık
      ...
      listTileTheme: const ListTileThemeData(
        ...
        iconColor: Color(0xFF444466),
      ),
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith(
          (s) => s.contains(WidgetState.selected) ? AppTheme.emerald : Colors.grey,
        ),
        trackColor: WidgetStateProperty.resolveWith(
          (s) => s.contains(WidgetState.selected)
              ? const Color(0x6650C878)
